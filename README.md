...
- Become a German grammar freak
- Learn the difference between verb conjugations, adjectives/adverbs, nouns, pronouns ...
- Works with any German text in docx, txt, pdf, epub, pptx format
- No coding required!
...
| -------------------------------------------------------------- |- |
Get any text you want to work with and save it as txt, docx or pdf.|<img src="50_800x800.png" width="400"/> |

| _,.-'``'-.,_,.'`` Step 2 ``'.,_,.-'``'-.,_|Screenshot|
| -------------------------------------------------------------- |- |
Start the app and select the text.|<img src="100_800x800.png" width="400"/> |

| _,.-'``'-.,_,.'`` Step 3 ``'.,_,.-'``'-.,_|Screenshot|
| -------------------------------------------------------------- |- |
Now you have to do the syntax analysis. The app will show you each<br>word, and you have to decide which tag fits best.|<img src="150_800x800.png" width="400"/> |

| _,.-'``'-.,_,.'`` Step 4 ``'.,_,.-'``'-.,_|Screenshot|
| -------------------------------------------------------------- |- |
For each right answer, you will get a point.|<img src="200_800x800.png" width="400"/> |
